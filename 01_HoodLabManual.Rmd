...
## OneDrive
  ...
  - Keep all data, R scripts, analyses, and manuscript drafts on Box (or the Z drive).
...
1.         Lab server(s): Is the permanent home for LEPAS and other datasets, as well as all materials related to your research (e.g., data, R code, manuscript drafts, SOPs)
...
Your manuscripts. A new subfolder for each manuscript. Often it is useful to have subfolders for data, scripts, figures, etc. within a manuscript folder.
